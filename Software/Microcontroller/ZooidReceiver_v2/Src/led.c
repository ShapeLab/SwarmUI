...
bool redBlinking, greenBlinking, blueBlinking, statusBlinking; 
...
void initLeds()
{
    ...
    redBlinking = greenBlinking = blueBlinking = statusBlinking = false;
    ...
    if (DEBUG_ENABLED()) GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
