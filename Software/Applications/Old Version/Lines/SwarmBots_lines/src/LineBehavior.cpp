...
void LineBehavior::init(vector<RobotState>* robots, int _nbRobots) {
    nbRobots = _nbRobots;
...
void LineBehavior::update(vector<RobotState>* robots) {
...
void LineBehavior::rectangle(vector<RobotState>* robots) {
    ...
    // count number of needed robots for each side
