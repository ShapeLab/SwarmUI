...
public:
	RobotState();
	~RobotState();
	RobotState(unsigned int _id, ofVec2f _position, ofVec2f _goal, ofColor _color);
...
public:
	...
	bool updateRobot(unsigned int id, ofVec2f position, float orientation, ofColor color);
